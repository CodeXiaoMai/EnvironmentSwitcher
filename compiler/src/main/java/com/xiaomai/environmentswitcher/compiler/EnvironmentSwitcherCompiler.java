    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        for (Element element : elements) {
            ...
            for (Element member : allMembers) {
                ...
                String urlName = member.getSimpleName().toString();
                String urlUpperCaseName = urlName.toUpperCase();
                String url = environmentAnnotation.url();
                String name = environmentAnnotation.name();
                String environmentName = name.isEmpty() ? urlName : name;
                ...
                getEnvironmentBuilder.addStatement(String.format("%s = new %s(\"%s\", \"%s\")", VAR_ENVIRONMENT_BEAN, ENVIRONMENT_BEAN, environmentName, url))
